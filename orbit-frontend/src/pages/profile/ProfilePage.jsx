    ...
    <div style={{ minHeight: '100vh', background: '#050508', fontFamily: "'Inter',sans-serif", padding: '40px 24px', display: 'flex', alignItems: 'flex-start', justifyContent: 'center' }}>
      ...
      <div style={{ width: '100%', maxWidth: 640, position: 'relative', zIndex: 1 }} className="anim-fade-in-up">
        ...
        <div style={{ background: '#0c0c18', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, overflow: 'hidden', boxShadow: '0 0 0 1px rgba(6,182,212,0.06), 0 24px 80px rgba(0,0,0,0.7)' }}>
          ...
          {/* Header bar */}
          <div style={{ padding: '28px 36px 28px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'linear-gradient(145deg,#06101f,#0c0c18)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <OrbitLogo size={44} color="white" />
              <div>
                <span style={{ fontSize: 17, fontWeight: 800, color: '#f59e0b', letterSpacing: '-0.01em' }}>SLIIT</span>
                <span style={{ fontSize: 17, fontWeight: 800, color: '#fff' }}> Orbit</span>
                <p style={{ fontSize: 10, color: 'rgba(6,182,212,0.6)', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', marginTop: 3 }}>My Profile</p>
              </div>
            </div>
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, marginBottom: 32 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 20, minWidth: 0 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <p style={{ fontSize: 17, fontWeight: 700, color: '#f1f5f9', margin: 0, lineHeight: 1.3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user?.name}</p>
                  <p style={{ fontSize: 13, color: '#475569', margin: '4px 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user?.email}</p>
                  <p style={{ fontSize: 11, color: '#1e293b', margin: '6px 0 0' }}>Click the camera icon to update photo · Max 5 MB</p>
                </div>
              </div>

              {/* Right: verification badge — pinned to corner, vertically centered */}
              <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center' }}>
                {user?.verified ? (
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '8px 16px', borderRadius: 99, background: 'rgba(16,185,129,0.10)', border: '1px solid rgba(16,185,129,0.3)', fontSize: 12, fontWeight: 700, color: '#34d399', whiteSpace: 'nowrap' }}>
                  ...
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '8px 16px', borderRadius: 99, background: 'rgba(245,158,11,0.10)', border: '1px solid rgba(245,158,11,0.3)', fontSize: 12, fontWeight: 700, color: '#fbbf24', whiteSpace: 'nowrap' }}>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 24, marginBottom: 16 }}>
              ...
              {detectedFaculty && campusIdValid && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }} className="anim-fade-in">
                  ...
                  <span style={{ fontSize: 13, fontWeight: 600, color: facultyColor }}>{detectedFaculty} Faculty</span>
                </div>
              )}
